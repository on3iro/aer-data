...
const normalize = (array) => array.reduce((acc, entity) => ({
    entities: {
        ...acc.entities,
        [entity.id]: entity,
    },
...
const NORMALIZEDDATA = EXPANSIONS.reduce((acc, id) => {
    ...
    const upgradedBasicNemesisCards = normalize(expansion.upgradedBasicNemesisCards || []);
    return {
        expansions: {
            ...acc.expansions,
            [id]: {
